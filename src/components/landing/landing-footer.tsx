      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-500 font-medium">
              <li><a href="#" className="hover:text-primary transition-colors italic">Business Case Estratégico</a></li>
              <li><a href="#" className="hover:text-primary transition-colors italic">Propensão de Fechamento</a></li>
              <li><a href="#" className="hover:text-primary transition-colors italic">Scoring & Qualificação</a></li>
              <li><a href="#" className="hover:text-primary transition-colors italic">Comunicação Persuasiva</a></li>
              <li><a href="#" className="hover:text-primary transition-colors italic">Inteligência Comportamental</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-500 font-medium">
              ...
              <li><a href="#" className="hover:text-primary transition-colors italic">Consultoria de Negociação</a></li>
              <li><a href="#" className="hover:text-primary transition-colors italic">Framework de Conversa</a></li>
              <li><a href="#" className="hover:text-primary transition-colors italic">Dossiê Pré-Reunião</a></li>
            </ul>
          </div>
